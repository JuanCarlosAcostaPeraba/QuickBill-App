...
\begin{itemize}
  \item \texttt{Models}: se definieron las entidades principales como \texttt{Client}, \texttt{Employee}, \texttt{Invoice}, \texttt{InvoiceLineItem}, \texttt{InvoiceStatus}, \texttt{Product}, , \texttt{ProductStack} y \texttt{TabItem}. La Figura \ref{fig:models_folder} muestra cómo se organizan los archivos en Xcode.
